...
public class WPIJavaCVExtension 
{
    private static CvMemStorage storage;

    public static CvSeq 
    getCvSeq(WPIContour contour)
    {
        return contour.getCVSeq();
    }

    public static WPIContour
    makeWPIContour(CvSeq seq)
    {
        return new WPIContour(seq);
    }

    public static WPIGrayscaleImage 
    makeWPIGrayscaleImage(IplImage arr)
    {
    ...
    public static WPIColorImage 
    makeWPIColorImage(IplImage arr)
    {
        IplImage tempImage = IplImage.create(arr.cvSize(), arr.depth(), 1);
        opencv_core.cvCopy(arr, tempImage);
    ...
    public static WPIBinaryImage 
    makeWPIBinaryImage(IplImage arr)
    {
        IplImage tempImage = IplImage.create(arr.cvSize(), arr.depth(), 1);
        opencv_core.cvCopy(arr, tempImage);
    ...
    public static IplImage 
    getIplImage(WPIImage image)
    {
        return image.image;
    }
    ...
    public static WPIContour[] 
    findConvexContours(WPIBinaryImage image)
    {
        ...
        ArrayList<WPIContour> results;
        results = new ArrayList<WPIContour>();
